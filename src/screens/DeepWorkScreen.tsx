...
const styles = StyleSheet.create({
  ...
  setContainer: { flex: 1, backgroundColor: Colors.background },
  safe:         { flex: 1 },
  ...
  captureTitle: {
    fontSize: 52, fontWeight: '200', color: Colors.textPrimary,
  ...
  captureGoalBox: {
    ...
    padding: 16, marginBottom: Spacing.lg, borderWidth: 1, borderColor: Colors.border,
  },
  captureGoalLabel: { fontSize: 10, color: Colors.textTertiary, fontWeight: '700', letterSpacing: 1.2, marginBottom: 6, textTransform: 'uppercase' },
  captureGoal:      { fontSize: 15, color: Colors.textPrimary, lineHeight: 23, fontWeight: '500' },
  captureFieldLabel: { fontSize: 11, color: Colors.textTertiary, fontWeight: '700', marginBottom: 8, marginTop: Spacing.md, letterSpacing: 0.8, textTransform: 'uppercase' },
  captureInput: {
    backgroundColor: Colors.surfaceSecondary, borderRadius: Radius.lg,
    borderWidth: 1.5, borderColor: Colors.border,
    padding: 16, fontSize: 15, color: Colors.textPrimary, minHeight: 76,
